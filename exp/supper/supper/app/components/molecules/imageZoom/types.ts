...
export type ProgrammaticZoomCallback = (event: { scale: number; x: number; y: number }) => void;
...
export type ZoomableUseGesturesProps = Pick<ZoomableLayoutState, 'width' | 'height' | 'center'> &
	Pick<
		ZoomableProps,
		| 'minScale'
		| 'maxScale'
