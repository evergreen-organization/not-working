				...
				<View style={styles.infoScreenContainer}>
					<View style={styles.infoItem}>
						...
						<Text style={styles.infoText}>
							A shiny coin. Collect one to gain {Config.gameDefaults.pointsPerCollectible} and gain
							an additional {Config.gameDefaults.shotsGainedPerCollectible} shots...it makes
							sense...don't think about it.
						</Text>
					</View>
					<View style={styles.infoItem}>
						<Image source={require('../assets/enemy_ship.png')} style={styles.enemyShipImage} />
						<Text style={styles.infoText}>
					...
					<View style={styles.infoItem}>
						<Image source={require('../assets/asteroid_two.png')} style={styles.asteroidImage} />
						<Text style={styles.infoText}>It's just an asteroid...don't run into it, maybe?</Text>
					</View>
					<TouchableOpacity
					...
					>
						<Text>Back To Title Screen</Text>
					</TouchableOpacity>
				</View>
