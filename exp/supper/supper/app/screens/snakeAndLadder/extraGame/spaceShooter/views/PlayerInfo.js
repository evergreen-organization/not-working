...
export default class PlayerInfo extends Component {
	...
	renderHealthBar = () => {
		...
		for (let i = 0; i < Config.playerStats.maxHealth; i++) {
			...
			healthBar.push(<View key={i} style={style} />);
		}
		return (
			...
			<View style={styles.playerInfo}>
				<View style={styles.innerContainer}>
					...
					<View style={styles.shotsLeftContainer}>
						...
						/> */}
						{/* <Text style={styles.playerInfoText}>{this.props.shotsLeft}</Text> */}
					</View>
				</View>
...
const styles = StyleSheet.create({
	...
	healthBarSegment: {
		width: (0.9 * this.screenX * Config.playerStats.maxHealth) / 10,
		borderColor: 'black',
