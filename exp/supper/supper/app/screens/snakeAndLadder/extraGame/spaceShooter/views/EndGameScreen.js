		...
		return (
			...
			>
				<View style={styles.EndGameScreen}>
					<Text style={styles.ohDearText}>Oh Dear, You've Died</Text>
					<Text style={styles.infoText}>Final Points: {this.props.points}</Text>
					<Text style={styles.infoText}>Enemies Destroyed: {this.props.enemiesDestroyed}</Text>
					<Text style={styles.infoText}>Shots Fired: {this.props.shotsFired}</Text>
