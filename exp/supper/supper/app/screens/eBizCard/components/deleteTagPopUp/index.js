...
export const DeleteTagPopUp = ({ isVisible, setVisible, handlePopUp, handleDelete, isLoading }) => {
	return (
		<PopUp isVisible={isVisible} setVisible={setVisible}>
			<View style={styles.popUpHeader}>
				<Text style={{ fontSize: 16, fontWeight: 700 }}>Confirmation</Text>

				<TouchableOpacity onPress={handlePopUp} style={styles.crossIconContainer}>
			...
			<View style={styles.popUpContent}>
				...
				<Text style={styles.popUpText}>
					...
					<Text style={{ color: colors.red, fontWeight: 'bold' }}>DELETE</Text> the tag?
				</Text>
			</View>
